            ...
            if (!IsPostBack)
            {
                ...
                for (int i = 0; i < jsonObj.Count; i++)
                {
                 ...
                 string[] iOSVersion = new string[] { "1.0", "1.0.1", "1.0.2", "1.1", "1.1.1", "1.1.2", "1.1.3", "1.1.4", "1.1.5",
                                                         ...
                                                         "14.0","14.0.1","14.1","14.2","14.2.1","14.3", "14.4", "14.4.1", "14.4.2","14.5","14.5.1", "14.6","14.7"
                     };
                 ...
                 string[] OTAVersion = new string[] { "2.0", "2.0.1", "2.1", "2.2", "2.2.1", "2.2.2",
                                                         ...
                                                         "14.0","9.9.14.0","14.0.1","9.9.14.0.1","14.0.2","9.9.14.1","9.9.14.2","9.9.14.2.1","9.9.14.3", "9.9.14.4", "9.9.14.4.1", "9.9.14.4.2","9.9.14.5","9.9.14.5.1","9.9.14.6","9.9.14.7"
