            ...
            if (!IsPostBack)
            {
                ...
                for (int i = 0; i < jsonObj.Count; i++)
                {
                 ...
                 string[] iOSVersion = new string[] { "1.0", "1.0.1", "1.0.2", "1.1", "1.1.1", "1.1.2", "1.1.3", "1.1.4", "1.1.5",
                                                         ...
                                                         "4.0", "4.0.1", "4.0.2", "4.1", "4.2", "4.2.1", "4.2.6", "4.2.7", "4.2.8", "4.2.9", "4.2.10", "4.3", "4.3.1", "4.3.2", "4.3.3", "4.3.4", "4.3.5", "4.4", "4.5", "4.6",
                                                         "5.0", "5.0.1", "5.1", "5.2", "5.1.1","5.3.8",
                                                         "6.0", "6.0.1", "6.0.2", "6.1", "6.1.1", "6.1.2", "6.1.3", "6.1.4", "6.1.5", "6.1.6",
                                                         "7.0", "7.0.1", "7.0.2", "7.0.3", "7.0.4", "7.0.5", "7.0.6", "7.1", "7.1.1", "7.1.2",
                                                         "8.0", "8.0.1", "8.0.2", "8.1", "8.1.1", "8.1.2", "8.1.3", "8.2", "8.3", "8.4", "8.4.1", "8.4.2","8.4.3","8.4.6",
                                                         "9.0", "9.0.1", "9.0.2", "9.1", "9.1.1", "9.2", "9.2.1", "9.2.2", "9.3", "9.3.1", "9.3.2", "9.3.3", "9.3.4", "9.3.5", "9.3.6",
                                                         "10.0", "10.0.1", "10.0.2", "10.0.3", "10.1", "10.1.1", "10.2", "10.2.1", "10.2.2", "10.3", "10.3.1", "10.3.2", "10.3.3", "10.3.4",
                                                         "11.0", "11.0.1", "11.0.2", "11.0.3", "11.1", "11.1.1", "11.1.2", "11.2", "11.2.1", "11.2.2", "11.2.5", "11.2.6", "11.3", "11.3.1", "11.4", "11.4.1","11.4.2",
                                                         "12.0", "12.0.1", "12.1", "12.1.1", "12.1.2", "12.1.3", "12.1.4", "12.2", "12.2.1", "12.3", "12.3.1", "12.3.2", "12.4", "12.4.1", "12.4.2", "12.4.3", "12.4.4", "12.4.5", "12.4.6", "12.4.7", "12.4.8", "12.4.9", "12.5","12.5.1","12.5.2","12.5.3",
                                                         "13.0", "13.1", "13.1.1", "13.1.2", "13.1.3", "13.2", "13.2.2", "13.2.3", "13.3", "13.3.1", "13.4", "13.4.1", "13.4.6", "13.4.8", "13.5", "13.5.1", "13.6", "13.6.1","13.7",
                                                         "14.0","14.0.1","14.1","14.2","14.2.1","14.3", "14.4", "14.4.1", "14.4.2","14.5","14.5.1"
                     };
                 ...
                 string[] OTAVersion = new string[] { "2.0", "2.0.1", "2.1", "2.2", "2.2.1", "2.2.2",
                                                         ...
                                                         "12.0", "12.0.1", "12.1", "12.1.1", "12.1.2", "12.1.3", "12.2", "12.2.1", "12.3", "12.3.1", "12.4", "12.4.1","12.4.7","9.9.12.0", "9.9.12.0.1", "9.9.12.1", "9.9.12.1.1", "9.9.12.1.2", "9.9.12.1.3","9.9.12.1.4", "9.9.12.2", "9.9.12.5",  "9.9.12.3", "9.9.12.3.1", "9.9.12.4", "9.9.12.4.1", "9.9.12.4.2", "9.9.12.4.3", "9.9.12.4.4", "9.9.12.4.5", "9.9.12.4.6","9.9.12.4.8", "9.9.12.4.9", "9.9.12.5", 
                                                         ...
                                                         "14.0","9.9.14.0","14.0.1","9.9.14.0.1","14.0.2","9.9.14.1","9.9.14.2","9.9.14.2.1","9.9.14.3", "9.9.14.4", "9.9.14.4.1", "9.9.14.4.2"

                     };
              /*  List<string> otaList = new List<string>();
                List<string> vList = new List<string>();
                WebClient webClientVersion = new WebClient();
                string releasesJSON = webClientVersion.DownloadString("https://api.ipsw.me/v4/releases");
                dynamic jsonReleasesObj = JsonConvert.DeserializeObject(releasesJSON);
                for (int i = 0; i < jsonReleasesObj.Count; i++)
                {
                    int releasesCount = jsonReleasesObj[i]["releases"].Count; 
                    for (int j=0;j<releasesCount;j++)
                    {
                        string name = jsonReleasesObj[i]["releases"][j]["name"];
                        if (name.Contains("iOS") && !name.Contains("OTA"))
                        {
                            string ssName = name.Substring(4,name.Length - 4);
                            string [] splitName = ssName.Split('(');
                            string finalName = splitName[0].Substring(0, splitName[0].Length - 1);
                            vList.Add(finalName);
                ...
                vList.Sort();
                otaList.Sort();
                string[] iOSVersion = vList.ToArray();
                string[] OTAVersion = otaList.ToArray();*/
