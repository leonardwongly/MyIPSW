    ...
    public partial class Link : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                string[] iOSVersion = new string[] { "1.0", "1.0.1", "1.0.2", "1.1", "1.1.1", "1.1.2", "1.1.3", "1.1.4", "1.1.5",
                                                        ...
                                                        "13.0", "13.1", "13.1.1", "13.1.2", "13.1.3", "13.2", "13.2.2", "13.2.3", "13.3", "13.3.1", "13.4", "13.4.1", "13.4.6", "13.5", "13.5.1"
                    };
                ...
                string[] OTAVersion = new string[] { "2.0", "2.0.1", "2.1", "2.2", "2.2.1",
                                                        ...
                                                        "13.0", "13.1", "13.2", "13.3", "13.3.1", "13.4", "13.4.1", "13.4.5", "13.4.6", "13.4.8", "13.5", "13.6", "9.9.13.0", "9.9.13.1", "9.9.13.1.1", "9.9.13.1.2", "9.9.13.1.3", "9.9.13.2", "9.9.13.2.2", "9.9.13.2.3", "9.9.13.3", "9.9.13.3.1", "9.9.13.4", "9.9.13.4.1","9.9.13.4.5", "9.9.13.4.6", "9.9.13.5", "9.9.13.5.1", "9.9.13.5.5, 9.9.13.6"
        ...
        protected void btnRetrieve_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                for (int i = 0; i < jsonObj.Count; i++)
                {
                    if (!otaLinks.Contains(jsonObj[i]["url"]))
                    {
                        otaLinks.Add(jsonObj[i]["url"]);
                        otaFS.Add(jsonObj[i]["filesize"]);
                    }
                }
