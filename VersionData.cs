...
namespace ipsw
{
    ...
    {
        public static readonly string[] iOSVersions;
        public static readonly string[] OTAVersions;

        static VersionData()
        {
            iOSVersions = new string[] { 
                "1.0", "1.0.1", "1.0.2", "1.1", "1.1.1", "1.1.2", "1.1.3", "1.1.4", "1.1.5",
                ...
                "8.0", "8.0.1", "8.0.2", "8.1", "8.1.1", "8.1.2", "8.1.3", "8.2", "8.3", "8.4", "8.4.1", "8.4.2","8.4.3",
            ...
            Array.Reverse(iOSVersions);

            OTAVersions = new string[] { 
                "2.0", "2.0.1", "2.1", "2.2", "2.2.1", "2.2.2",
