        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="Link.aspx">Link</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <main class="container py-4">
            <section class="page-hero mb-4">
                <div class="d-flex flex-column flex-lg-row align-items-start align-items-lg-center justify-content-between gap-3">
                    <div>
                        <span class="hero-badge mb-3"><i class="bi bi-link-45deg"></i> Sharable download links</span>
                        <h1 class="h2 fw-semibold mb-2">Generate and share IPSW links instantly.</h1>
                        <p class="mb-0">Use the same three-step flow and then open or download all matched files at once.</p>
                    </div>
                        ...
                        <div class="card-body d-flex flex-column">
                            <div class="d-flex align-items-center gap-3 mb-3">
                                ...
                                <div>
                                    ...
                                    <small class="text-muted">Generate download links</small>
                                </div>
                            </div>
                    ...
                    <div class="card results-card">
                        <div class="card-body">
                            <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-3 mb-3">
                                <div>
                                    <h5 class="mb-1">Generated Links</h5>
                                    <p class="mb-0 text-muted">Copy individual URLs or open everything in new tabs.</p>
                                </div>
