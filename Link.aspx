<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Link.aspx.cs" Inherits="ipsw.Link" Async="true" %>
                    ...
                    <div class="col-sm" style="margin-top: 30px">
                        ...
                        <div class="row">
                            <asp:RadioButtonList ID="rblOptions" runat="server" AutoPostBack="True"
                                OnSelectedIndexChanged="rblOptions_SelectedIndexChanged" CssClass="form-check">
                    ...
                    <div class="col-sm" style="margin-top: 30px;">
                        ...
                        <div class="row">
                            <asp:DropDownList ID="ddlVersion" runat="server" AutoPostBack="true"
                                OnSelectedIndexChanged="ddlVersion_SelectedIndexChanged" CssClass="form-control">
                        ...
                        <div class="row">
                            <asp:DropDownList ID="ddlVersionOTA" runat="server" AutoPostBack="true"
                                OnSelectedIndexChanged="ddlVersionOTA_SelectedIndexChanged" CssClass="form-control">
                        ...
                        <div class="row">
                            <asp:DropDownList ID="ddliPad" runat="server" AutoPostBack="True"
                                OnSelectedIndexChanged="ddliPad_SelectedIndexChanged" CssClass="form-control">
                        ...
                        <div class="row">
                            <asp:DropDownList ID="ddliPod" runat="server" AutoPostBack="True"
                                OnSelectedIndexChanged="ddliPod_SelectedIndexChanged" CssClass="form-control">
                        ...
                        <div class="row">
                            <asp:DropDownList ID="ddlWatch" runat="server" AutoPostBack="True"
                                OnSelectedIndexChanged="ddlWatch_SelectedIndexChanged" CssClass="form-control">
                        ...
                        <div class="row">
                            <asp:DropDownList ID="ddlMac" runat="server" AutoPostBack="True"
                                OnSelectedIndexChanged="ddlMac_SelectedIndexChanged" CssClass="form-control">
                        ...
                        <div class="row">
                            <asp:DropDownList ID="ddlAudioAccessory" runat="server" AutoPostBack="True"
                                OnSelectedIndexChanged="ddlAudioAccessory_SelectedIndexChanged" CssClass="form-control">
                        ...
                        <div class="row">
                            <asp:DropDownList ID="ddlAppleTV" runat="server" AutoPostBack="True"
                                OnSelectedIndexChanged="ddlAppleTV_SelectedIndexChanged" CssClass="form-control">
                    ...
                    <div class="col-sm">
                        <div class="card">
                            ...
                            <asp:Button ID="btnDownloadAll" runat="server" Text="Download All" Visible="false"
                                OnClientClick="downloadAll()" CssClass="btn btn-primary" />
                        </div>
